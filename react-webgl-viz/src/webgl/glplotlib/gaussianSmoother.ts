...
export class GaussianSmoother {
  ...
  */
   constructor(smoothing: number = GaussianSmoother.DefaultSmoothing, kernelSize: number = GaussianSmoother.DefaultKernelSize) {
   ...
   private static checkSmoothing(smoothing: number): number {
      ...
      // in range case
      if (smoothing >= GaussianSmoother.MinSmoothing && smoothing <= GaussianSmoother.MaxSmoothing) {
         return smoothing;
      }
   ...
   private static checkKernelSize(kernelSize: number) {
      ...
      // in range case
      if (kernelSize >= GaussianSmoother.MinKernelSize && kernelSize <= GaussianSmoother.MaxKernelSize) {
         return kernelSize;
      }
   ...
   */
   private createKernel() {
      this._gaussianCoefficients = GaussianSmoother.generate1DGaussianCoefficients(this.getKernelSize(), this.getSmoothing());
   ...
   coefficients(): Float32Array {
      return GaussianSmoother.generate1DGaussianCoefficients(this.getKernelSize(), this.getSmoothing());
   }
   ...
   coefficientsNormalized(): Float32Array {
      let coeff = GaussianSmoother.generate1DGaussianCoefficients(this.getKernelSize(), this.getSmoothing());
   ...
   coefficients2D(): Float32Array {
      return GaussianSmoother.generate2DGaussianCoefficients(this.getKernelSize(), this.getSmoothing());
   }
   ...
   static generate2DGaussianCoefficients(kernelSize: number, sigma: number): Float32Array {
      ...
      let coeff1D: Float32Array = GaussianSmoother.generate1DGaussianCoefficients(kernelSize, sigma);
    ...
    */
   static checkArrays(sourceData: Float32Array | Uint32Array | Uint16Array, destData: Float32Array) {
    ...
    */
   static convolveHorz(src: Float32Array | Uint32Array | Uint16Array, dest: Float32Array, rowWidth: number, coefficients: Float32Array) {
    ...
    * @param {Float32Array} coefficients - the gaussian smoothing array
    */
   static convolveVert(src: Float32Array | Uint32Array | Uint16Array, dest: Float32Array, rowWidth: number, coefficients: Float32Array) {
      let kernelSize = coefficients.length;
      let halfKernel = (kernelSize / 2) | 0;
      let numRows = (dest.length / rowWidth) | 0;
    ...
    * @param {Float32Array} coefficients - the gaussian smoothing array
    */
   static convolveLeftHorz(src: Float32Array | Uint32Array | Uint16Array, dest: Float32Array, rowWidth: number, coefficients: Float32Array) {
      let kernelSize = coefficients.length;
      let halfKernel = (kernelSize / 2) | 0;
      let numRows = (dest.length / rowWidth) | 0;
    ...
    * @param {Float32Array} coefficients - the gaussian smoothing array
    */
   static convolveRightHorz(src: Float32Array | Uint32Array | Uint16Array, dest: Float32Array, rowWidth: number, coefficients: Float32Array) {
      let kernelSize = coefficients.length;
      let halfKernel = (kernelSize / 2) | 0;
      let numRows = (dest.length / rowWidth) | 0;
      let rowOffset = 0;
    ...
    * @param {Float32Array} coefficients - the gaussian smoothing array
    */
   static convolveTopVert(src: Float32Array | Uint32Array | Uint16Array, dest: Float32Array, rowWidth: number, coefficients: Float32Array) {
      let kernelSize = coefficients.length;
      let halfKernel = (kernelSize / 2) | 0;
       // @ts-ignore
      let numRows = (dest.length / rowWidth) | 0;
   ...
   * @param {Float32Array} coefficients - the gaussian smoothing array
   */
   static convolveBottomVert(src: Float32Array | Uint32Array | Uint16Array, dest: Float32Array, rowWidth: number, coefficients: Float32Array) {
      let kernelSize = coefficients.length;
      let halfKernel = (kernelSize / 2) | 0;
      let numRows = (dest.length / rowWidth) | 0;
   ...
   */
   smooth<T extends Float32Array | Uint32Array | Uint16Array>(src: T, dest: Float32Array, rowWidth: number, smoothEdges: boolean = true) {
      ...
      if (numRows > 1) {
         ...
         if (smoothEdges) {
            GaussianSmoother.convolveTopVert(scratch, dest, rowWidth, this._gaussianCoefficients);
            GaussianSmoother.convolveBottomVert(scratch, dest, rowWidth, this._gaussianCoefficients);
         }
      }
