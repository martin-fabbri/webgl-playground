   ...
   */
   ...
   updateViewport(viewportPercent: { xmin: number, xmax: number, ymin: number, ymax: number }) {
      ...
      let projMatrix = Matrix4.createViewportTransform({
         srcLeft: 2 * viewportPercent.xmin - 1, srcRight: 2 * viewportPercent.xmax - 1, destLeft: -1, destRight: 1,
         srcBottom: 2 * viewportPercent.ymin - 1, srcTop: 2 * viewportPercent.ymax - 1, destBottom: -1, destTop: 1,
