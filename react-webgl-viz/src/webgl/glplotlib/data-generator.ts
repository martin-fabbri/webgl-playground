 ...
 */
   ...
   static getXYRange(xScale: ScaleType, yScale: ScaleType, dataRange: number) {
    ...
    static createBitarrayTransformMatrix(devWidth: number, devHeight: number, dataRange: number, zoomTransform: IZoomTransform = { x: 0, y: 0, k: 1 }) {
      ...
      let mat4 = Matrix4.createViewportTransform({
         srcLeft: xmin, srcRight: xmax, destLeft: -1, destRight: 1,
         srcBottom: ymin, srcTop: ymax, destBottom: -1, destTop: 1,
    ...
    * @param zoomTransform 
    */
   static createFcsTransformMatrix(xScale: ScaleType, yScale: ScaleType, devWidth: number, devHeight: number,
      dataRange: number, zoomTransform: IZoomTransform = { x: 0, y: 0, k: 1 }) {
      ...
      let projMatrix = Matrix4.createViewportTransform({
         srcLeft: rInfo.xmin, srcRight: rInfo.xmax, destLeft: -1, destRight: 1,
         srcBottom: rInfo.ymin, srcTop: rInfo.ymax, destBottom: -1, destTop: 1,
         srcFront: 255, srcBack: 0, destFront: -1, destBack: 0
      });

      // take the fractional NDC and scale to [-1, 1]
      let zoomMatrix = Matrix4.createViewportTransform({
         srcLeft: 2 * zinfo.xmin - 1, srcRight: 2 * zinfo.xmax - 1, destLeft: -1, destRight: 1,
         srcBottom: 2 * zinfo.ymin - 1, srcTop: 2 * zinfo.ymax - 1, destBottom: -1, destTop: 1,
         srcFront: -1, srcBack: 0, destFront: -1, destBack: 0
      });
   ...
   static createTransformMatrix() {
      ...
      return Matrix4.createViewportTransform({
         srcLeft: 0, srcRight: 255, destLeft: -1, destRight: 1,
         srcBottom: 0, srcTop: 255, destBottom: -1, destTop: 1,
         srcFront: 255, srcBack: 0, destFront: -1, destBack: 0
      });
   }
   ...
   static createLogTransformMatrix() {
      ...
      return Matrix4.createViewportTransform({
         srcLeft: 0, srcRight: logMax, destLeft: -1, destRight: 1,
         srcBottom: 0, srcTop: 255, destBottom: -1, destTop: 1,
         srcFront: 255, srcBack: 0, destFront: -1, destBack: 0
      });
   }
   ...
   static createBiexpTransformMatrix_forY() {
      ...
      return Matrix4.createViewportTransform({
         srcLeft: 0, srcRight: 255, destLeft: -1, destRight: 1,
         srcBottom: biexpMin, srcTop: biexpMax, destBottom: -1, destTop: 1,
         srcFront: 255, srcBack: 0, destFront: -1, destBack: 0
      });
   }
   ...
   static createBiexpTransformMatrix() {
      ...
      // create a xform to go from 0->logMax to -1 -> +1, z +10 to -10
      return Matrix4.createViewportTransform({
         srcLeft: biexpMin, srcRight: biexpMax, destLeft: -1, destRight: 1,
         srcBottom: 0, srcTop: 255, destBottom: -1, destTop: 1,
         srcFront: 255, srcBack: 0, destFront: -1, destBack: 0
      });
   }
